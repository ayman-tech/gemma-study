...
> **Note:** In CPU mode (`--device cpu`), 4-bit loading sets `llm_int8_enable_fp32_cpu_offload=True` in bitsandbytes (the parameter name includes `int8`, but this is the correct config used here).
